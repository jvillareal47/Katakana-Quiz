...
const quizData = [
    ...
    { katakana: "チョコチップクッキー", romaji: ["Choko Cippu Kukkī", "Choko Chippu Kukkii"], english: ["Chocolate Chip Cookie"] },
    { katakana: "エアコン", romaji: ["Eakon"], english: ["Aircon", "Air Conditioner"] },
    { katakana: "キッチンセット", romaji: ["Kitchin Setto"], english: ["Kitchen Set"] },
    ...
    { katakana: "フルーツ", romaji: ["Furūtsu", "Furuutsu"], english: ["Fruit"] },
